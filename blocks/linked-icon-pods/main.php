...
add_action('acf/init', 'ccc_primary_register_linked_icon_pods_block');

/**
 * Registers the Linked Icon Pods block and its fields.
 */
function ccc_primary_register_linked_icon_pods_block(): void
{
    ...
    acf_register_block_type(
        [
            'name'            => 'ccc-linked-icon-pods',
            'title'           => __('Linked Icon Pods', 'ccc-primary-theme'),
            'description'     => __('Displays a grid of linked icon pods.', 'ccc-primary-theme'),
            'render_callback' => 'ccc_primary_render_linked_icon_pods_block',
            'category'        => 'layout',
            'icon'            => 'screenoptions',
            'keywords'        => ['icons', 'links', 'grid', 'cards'],
            'supports'        => [
                'align'  => false,
                'anchor' => true,
                'mode'   => true,
    ...
    ccc_primary_register_linked_icon_pods_fields();
}

/**
 * Registers ACF fields for the Linked Icon Pods block.
 */
function ccc_primary_register_linked_icon_pods_fields(): void
{
    ...
    acf_add_local_field_group(
        [
            'key'                   => 'group_ccc_linked_icon_pods',
            'title'                 => __('Linked Icon Pods', 'ccc-primary-theme'),
            'fields'                => [
                [
            ...
            'location'              => [
                [
                    [
                        'param'    => 'block',
                        'operator' => '==',
                        'value'    => 'acf/ccc-linked-icon-pods',
                    ],
                ],
            ],
            'position'              => 'normal',
 ...
 */
function ccc_primary_render_linked_icon_pods_block(array $block, string $content = '', bool $is_preview = true): void
{
    $context = [
        'block'      => $block,
        'pods'       => get_field('pods') ?: [],
